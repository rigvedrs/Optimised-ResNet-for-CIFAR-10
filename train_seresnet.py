...
full_dataset = CIFAR10CombinedDataset(root_dir)
...
for fold, (train_idx, val_idx) in enumerate(kf.split(full_dataset)):
    ...
    train_subset.dataset = CIFAR10CombinedDataset(root_dir)
    val_subset.dataset = CIFAR10CombinedDataset(root_dir)
    ...
    for epoch in range(max_epochs):
        ...
        for inputs, targets in train_loader: #ricap#
            ...
            train_accuracy += compute_accuracy(outputs, labels)[0].item() * batch_size
        ...
        avg_train_accuracy = 100. * train_accuracy / train_samples
        ...
        with torch.no_grad():
            for inputs, labels in val_loader:
                ...
                batch_loss = standard_criterion(outputs, labels)
    ...
    # Save as JSON
    with open(os.path.join(experiment_dir, f'fold_{fold}_metrics.json'), 'w') as f:
        json.dump(metrics, f)
