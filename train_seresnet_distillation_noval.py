...
full_dataset = CIFAR10CombinedDataset(root_dir, test_dir, transform=train_transform)

train_collator = RICAPCollator() #ricap#
train_loader = DataLoader(full_dataset, batch_size=128, shuffle=True, num_workers=8, pin_memory=True, collate_fn=train_collator,) #ricap#
...
#optimizer = optim.SGD(param_groups, lr=0.1, momentum=0.9, weight_decay=1e-4, nesterov=True)
